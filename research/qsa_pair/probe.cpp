...
int main(int argc,char** argv) {
  ...
  for(int G:{0,2,0}) {
    ...
    auto fn=mx::fast::metal_kernel("qsa_bucketed",{"q","k","v","scl","blocks","tilepos","tilemask"},{"out"},read_file("src/kernels/qsa_pair.metal"),header,false);
    ...
    std::cout<<"{\"G\":"<<G<<",\"S\":"<<S<<",\"KV\":"<<KV<<",\"max_tiles\":"<<NT<<",\"tiles\":"<<work_tiles<<",\"active_tiles\":"<<active_tiles<<",\"ms\":"<<ts[1]<<",\"max_diff\":"<<diff<<",\"rmse\":"<<rmse<<",\"plan_included\":true}"<<std::endl;
  }
}
