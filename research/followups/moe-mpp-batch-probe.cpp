...
int main(int argc,char**argv) {
  const int S=argc>1?(std::string(argv[1])=="wide32"?32768:(std::string(argv[1])=="wide16"?16384:8192)):257,E=512,TOPK=10,M=S*TOPK,H=2560,I=640;
  ...
  rng.seed(4178623); // same weights across the two token widths
  ...
  for(int mode:std::vector<int>{1,5,1}) {
