...
ReleaseFast build passed (7/7 steps). Focused Zig test passed (9/9 build steps, 3/3 executed tests): B2/S17 and B1/S65, with and without a pending write; exact write, normalization, one-hot inject mapping and BF16 mix. The clean source copy in draft PR #408 subsequently passed the full suite: 2349 passed, 154 skipped, 0 failed; ReleaseFast 7/7 steps. `../pr-validation.json` pins the source hashes. Broader HC numerical/model-quality coverage and final llmprobe are still pending.
